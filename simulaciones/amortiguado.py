...
plt.plot(t_sol_damped, x_sol_damped, label='Amortiguado')
plt.plot(t_sol_nonLinear, x_sol_nonLinear, label='No amortiguado')
plt.xlabel(r'Tiempo(s)')
plt.ylabel(r'$\theta(t)$')


plt.legend(loc='upper left', fontsize=8)
# plt.legend(bbox_to_anchor=(0.7, 1), loc='upper left', fontsize=6)
plt.grid(True)
plt.savefig("./images/amortiguamiento.png", dpi=300)
plt.show()
